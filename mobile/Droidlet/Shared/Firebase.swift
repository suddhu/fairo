...
class Droidbase {
    ...
    private let recognitionUrl = "https://yss21031-default-rtdb.firebaseio.com/human-object-recognition.json"
    ...
    func getObjectAPI(completion: ((UIImage) -> ())?) {
        ...
        var request = URLRequest(url: URL(string: recognitionUrl)!,timeoutInterval: Double.infinity)
