...
class UserSettings: ObservableObject {
    ...
    func visionRequest(_ pixelBuffer: CVPixelBuffer) {
        ...
        let request = VNCoreMLRequest(model: visionModel) { request, error in
            ...
            DispatchQueue.main.async {
                ...
                self.askName(suggestion: named, confidence: confidence)
            }
        }
...
extension UserSettings {
    func request() {
        ...
        visionRequest(pixelBuffer)
    }
    
    func askName(suggestion: String, confidence: String) {
